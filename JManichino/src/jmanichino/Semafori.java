 ...
 * @file Semafori.java
 * 
 * @brief classe semplice che gestisce la Wait e la Signal di un generico semaforo
 * 
 */
public class Semafori {
     ...
     * 
     * @param[in] val intero che indica il valore di inizializzazione del semaforo
     */
    public  Semafori(int val) {this.valore = val;}
